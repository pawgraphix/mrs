                                ...
                                @foreach($items as $key=>$item)
                                    <tr>
                                        ...
                                        <td style="width: 12%;text-align: center">
                                            <a class="edit-link btn-sm btn-primary waves-effect waves-light m-b-5" href="{{route('locations.edit',$item->id)}}">Edit</a>
                                            | <a class="delete-link btn-sm btn-danger waves-effect waves-light m-b-5" href="{{route('locations.destroy',$item->id)}}">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
